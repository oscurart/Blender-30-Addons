...
def main(context,vaxis,gpAxis):
    ...
    for vertice in bm.verts:
        if vertice.select:
            ...
            jj= [point.co for point in bpy.context.scene.grease_pencil.layers.active.frames[0].strokes[0].points]
            for point in bpy.context.scene.grease_pencil.layers.active.frames[0].strokes[-1].points:
